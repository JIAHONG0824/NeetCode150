...
--- 
### 1.solutions 
Either p and q are both greater than the root\
or both are less than the root\
until one is greater and the other is less than the root.
```python
...
class Solution:
    def lowestCommonAncestor(
        ...
        while True:
            # p and q are less than the root
            if root.val > p.val and root.val > q.
                root = root.left
            # p and q are greater than the root
